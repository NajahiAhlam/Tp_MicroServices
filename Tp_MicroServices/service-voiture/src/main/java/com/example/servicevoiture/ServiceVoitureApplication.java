...
public class ServiceVoitureApplication {
	...
	CommandLineRunner initialiserBaseH2(VoitureRepository voitureRepository, ClientService clientService) {
		...
		return args -> {
			...
			voitureRepository.save(new Voiture(Long.parseLong("2"), "Toyota", "B 4 3456", "Megane", 1L, c2));
			voitureRepository.save(new Voiture(Long.parseLong("3"), "Toyota", "A 55 4444", "301", 2L, c1));
		};
	}
